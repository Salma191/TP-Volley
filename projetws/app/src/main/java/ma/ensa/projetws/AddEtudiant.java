...
public class AddEtudiant extends AppCompatActivity implements View.OnClickListener {
    ...
    String insertUrl = "http://192.168.182.43/Projet/ws/createEtudiant.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Redirigez l'utilisateur vers l'activité StudentListActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.menu, menu); // Utilisez le nom de votre fichier de menu XML
        return true;
    }
